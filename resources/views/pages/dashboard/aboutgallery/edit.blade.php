          ...
          <div class="card-body">
            ...
            <form action="{{ route('about.update', $about->id) }}" method="POST">
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <input type="text" name="sejarah" value="{{ old('sejarah') ?? $about->sejarah }}" class="form-control">
                </div>
              </div>
              <div class="row mb-3">
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <input type="text" name="filosofi" value="{{ old('filosofi') ?? $about->filosofi }}" class="form-control">
                </div>
              </div>
              <div class="row mb-3">
